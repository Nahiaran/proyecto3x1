...
<div class="w3-content" style="max-width:1100px;">
  ...
  <div class="w3-container">
    <div class="w3-panel w3-padding-16 w3-black w3-opacity w3-card w3-hover-opacity-off">
      ...
      <input class="w3-input w3-border" onclick="history.go(0) type="text" name="email" placeholder="Tu dirección de Email">
      <br>
      <input type="submit" onclick="alert('Genial! Tu correo ha sido registrado en nuestra Newsletter, pronto recibirás actualizaciones de nuestro servicio.');" value="Suscríbete" class="w3-button w3-red w3-margin-top">
      </div>
  </div>
